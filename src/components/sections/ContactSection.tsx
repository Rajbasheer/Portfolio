...
const ContactSection = () => {
  ...
  return (
    ...
    >
      {/* Header Container */}
      <div className="fixed top-0 left-0 right-0 z-30 bg-deep-space/80 backdrop-blur-md border-b border-neon-blue/20 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-neon-cyan to-neon-purple text-transparent bg-clip-text">
